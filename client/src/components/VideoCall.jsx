        ...
        <div className="flex flex-wrap items-center justify-center gap-3 md:gap-4 p-3 md:p-4 bg-white/10 backdrop-blur-2xl rounded-[2rem] border border-white/20 shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] w-full">
          {status === 'idle' ? (
            ...
            <>
              <button
                onClick={toggleAudio}
                className={`rounded-full p-4 transition-all duration-300 shadow-lg flex items-center justify-center ${
                  isAudioMuted
              ...
              >
                {isAudioMuted ? (
                  <MicOffIcon className="text-[28px]" />
                ) : (
              ...
              >
                {isVideoOff ? (
                  <VideoOffIcon className="text-[28px]" />
                ) : (
